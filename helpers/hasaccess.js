...
function evalAccess(message, level) {
    if (message.guild.ownerID === message.author.id || message.member.hasPermission("ADMINISTRATOR")) return true;
    let can_do = false;
    console.log(level);
...
module.exports = { has_permission: { check_tier: evalAccess, check_list: evalPerms } };