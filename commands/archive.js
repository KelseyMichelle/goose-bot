...
module.exports = {
  name: "archive",
  description:
    "posts an archived #oneforthearchives item, or adds if theres an attachment included ",
  syntax: `${
    prefix + this.name
  } [archive name] (note: quotation marks are not needed here)`,
  access_level: 0,
  hidden: false,
